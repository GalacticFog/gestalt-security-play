...
class AccountServiceImpl() extends IdentityService[AuthAccount] {
  override def retrieve(loginInfo: LoginInfo): Future[Option[AuthAccount]] = Future.successful(
    loginInfo match {
...
class AccountServiceImplWithCreds() extends IdentityService[AuthAccountWithCreds] {
  override def retrieve(loginInfo: LoginInfo): Future[Option[AuthAccountWithCreds]] = Future.successful(
    loginInfo match {
