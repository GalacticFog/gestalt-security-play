...
class GestaltDelegatedSecurityEnvironment[A <: Authenticator : TypeTag] @Inject() ( securityConfig: GestaltSecurityConfig,
...
class GestaltFrameworkSecurityEnvironment[A <: Authenticator : TypeTag] @Inject() ( securityConfig: GestaltSecurityConfig,
                                                                                    securityClient: GestaltSecurityClient,
                                                                                    bus: EventBus,
